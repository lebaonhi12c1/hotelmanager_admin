    ...
    return (
        <div>
            <div className="max-w-sm p-6 flex flex-col gap-2 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                {
                    ( !(value?.status == 'checkedIn') && !(value?.status == 'spending') && !(value?.status == 'confirmed') ) &&
                    (
                        <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-slate-700 rounded-lg focus:ring-4 focus:outline-none focus:ring-slate-300 dark:bg-slate-600 dark:hover:bg-slate-700 dark:focus:ring-slate-800 justify-center"
                        >
                            Hoàn thành
                        </a>
                    )
